 ...
 * 10/25/2017: Local ID "Green"
 * 11/9/2017:  Default Pattern 3 - pulse train starts in setup()
...
// Default Pulse Train Parameters - Pattern 3
#define PEAKDURATION 2000       // 2 milliseconds, 2000 microseconds
#define PEAKNUMBER 10           // total number of peaks, on + off
#define CYCLEPERIOD 200         // 100 millisecond, 100000 microseconds
#define CYCLENUMBER 5          // number of cycles before pause
...
void setup() 
{
  // set pulse train to defaults - pattern 3
  ...
  blePeripheral.setLocalName("Green"); // local name will vary with the board this is downloaded into
