...
// Default Pulse Train Parameters - Pattern 2
...
void setup() 
{
  // set pulse train to defaults - pattern 2
  ...
  blePeripheral.setLocalName("Blue"); // local name will vary with the board this is downloaded into
